...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light rounded" style="box-shadow: 0px 1px 1px rgba(0, 0, 0, 0.15)">
  ...
  <div id="formContent">
   ...
   @endif
    ...
    @if (Route::has('password.request'))
        <a class="" href="<?php echo(\Config::get('app.url').'/password/reset')?>">
