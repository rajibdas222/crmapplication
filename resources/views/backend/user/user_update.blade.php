                ...
                <div class="card-header border-bottom text-center">
                    <div class="mb-3 mx-auto" id="image_id">
                        <img class="rounded-circle"
                            src="{{config('app.url').'storage/app'.config('const.USER_UPLOAD_IMAGES_PATH').$user->image}}"
                        ...
                        <div class="row" id="div">
                            <div class="col">
                                <form method="POST" id="update_user" class="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="update_full_name">{{__('messages.full_name')}}</label>
                                            <input id="update_full_name" type="text" class="form-control"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="update_dob">{{__('messages.date_birth')}}</label>
                                            <input id="update_dob" type="date" class="form-control" name="dob"
