...
<div id="permission_main_message">
...
<div class="main-content-container container-fluid px-4">
	...
	<div class="row" id="div">
						...
						<div class="row">
							<div class="col">
								<form action="<?php echo(\Config::get('app.url').'/permission_insert')?>" method="post">
									...
									<button id="permission_button" type="submit" class="btn btn-primary"></i>
		...
		@can('permission_view')
		<div class="col-sm-8" id="permission_list">
			<div class="card card-small mb-4">
				<div class="card-header border-bottom">
							...
							<tr>
								...
								<td>
									...
									<a class="btn btn-info"
										href="<?php echo(\Config::get('app.url').'permission/'.$permission->id);?>">
								...
								<td>
									...
									<button type="button" class="btn btn-danger permission_delete"
										id="{{$permission->id}}"><i class="fas fa-trash-alt"></i>{{__('messages.delete')}} </button>
									@endif
									@endcan
								</td>
							</tr>
