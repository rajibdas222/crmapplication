...
<div id="assign_permission_message"></div>
<div class="main-content-container container-fluid px-4">
	...
	@can('assign_permission_to_user_view')
	<div class="row">
		<div class="col-sm-12">
							...
							<div class="col">
								<form method="post">
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<select class="custom-select custom-select-lg mb-3" name="user_id" id="user_id_for_permission">
									...
									<div class="row">
										...
										<div class="col-md-4 col-lg-4">
											<div class="select-permission-wrapper my-4">
												...
												@can('assign_permission_to_user_update')
												<div id="save_button">
