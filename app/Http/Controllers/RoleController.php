...
class RoleController extends Controller
{
    ...
    public function get_role(Request $request){
        $roles=Role::select('id as role_id','name as role_name')->get();
        $role_permission_array=array();
        foreach ($roles as $key => $role) {
            $permissions['role_id']=$role->role_id;
            $permissions['role_name']=$role->role_name;
            $permissions['permissions']= $this->get_role_permission_by_role_id($role->role_id,$status='user_add');
            $role_permission_array[]=$permissions;
        }
